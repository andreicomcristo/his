...
public class DesfechoController {
    ...
    public String listar(@RequestParam(required = false) String nome,
        ...
        return "pages/care/attendance/desfechos/list";
    }
    ...
    public String novo(@RequestParam(required = false) Long atendimentoId,
        ...
        return "pages/care/attendance/desfechos/form";
    }
    ...
    private void populateReferences(Model model, Long atendimentoSelecionadoId) {
        ...
        model.addAttribute("tiposDesfecho", tipoDesfechoRepository.findByAtivoTrueOrderByDescricaoAsc());
        model.addAttribute("motivosDesfecho", motivoDesfechoRepository.findByAtivoTrueOrderByDescricaoAsc());
        model.addAttribute("destinosRede", destinoRedeRepository.findByAtivoTrueOrderByDescricaoAsc());
    }
