...
public interface TipoUnidadeRepository extends JpaRepository<TipoUnidade, Long> {
    ...
    List<TipoUnidade> findAllByOrderByDescricaoAsc();

    List<TipoUnidade> findByAtivoOrderByDescricaoAsc(Boolean ativo);
    ...
    @Query("""
            ...
            """)
    List<TipoUnidade> listarPorBusca(String q);
    ...
    @Query("""
            ...
            order by t.descricao
            """)
    List<TipoUnidade> listarPorFiltroComBusca(Boolean ativo, String q);
